...
Figure 1 shows what an article would look like on the SPIP system. Features to note include: the on the centertop centre shows the text with few classic metadata; the main screen shows the body of the article; the on the top left shows some useful navigational tools; the on the center left shows footnotes and additional notes; and the on the bottom left shows enriched content, such as a Zotero bibliography or few additional links.
...
Figure 2 shows what an article looks like in the Le Pressoir factory system. Features to note include:on the top of the page has a few navigation tools, such as the menu of chapters, links to previous/next chapters, and a link to the book list of the series; on the left sidebar shows the navigational menu for the chapter; and on the center of the page shows the text and the enriched content with a “+” sign as a way to find out information about indexed items (people, places, or subjects), and clickable bibliographical references.
